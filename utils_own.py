...
# 加载工况参数
case_params_path = r'E:\WPS Office\1628575652\WPS企业云盘\清华大学\我的企业文档\课题组相关\理想项目\仿真数据库相关\distribution\distribution_1111.csv'
...
example_case_ids = list(np.random.choice(np.arange(1, 101), size=100, replace=False))  # 示例 case_id 列表
example_case_ids = [5254,6878,8172,4532,698,918,58,2542,3078,1153,1976,2068,4120,1043,7760]
data_dir = r'G:\VCS_acc_data\acc_data_before1111_6134'
save_dir = r'G:\VCS_acc_data\acc_data_before1111_6134\acceleration_plots_TEST'
