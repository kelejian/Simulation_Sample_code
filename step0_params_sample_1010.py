...
distribution_file = r'E:\课题组相关\理想项目\仿真数据库相关\distribution\distribution_1029_V6.csv'
new_filename = r'E:\课题组相关\理想项目\仿真数据库相关\distribution\distribution_1103.csv'
...
sample_restraint_params(filename=distribution_file, new_filename=new_filename, case_ids=case_ids_to_fill, skip_points=34000, seed=20251103)
