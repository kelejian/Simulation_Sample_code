...
# %% 第二部分：对剩余约束系统参数（包括座椅、乘员体征等参数）进行均匀采样（主驾侧和副驾侧一起采样）
import numpy as np
import pandas as pd
from scipy.stats import qmc
...
distribution_file = r'E:\WPS Office\1628575652\WPS企业云盘\清华大学\我的企业文档\课题组相关\理想项目\仿真数据库相关\distribution\distribution_1025_V6.csv'
new_filename = r'E:\WPS Office\1628575652\WPS企业云盘\清华大学\我的企业文档\课题组相关\理想项目\仿真数据库相关\distribution\distribution_1026.csv'
...
sample_restraint_params(filename=distribution_file, new_filename=new_filename, case_ids=case_ids_to_fill, skip_points=33000, seed=20251026)
